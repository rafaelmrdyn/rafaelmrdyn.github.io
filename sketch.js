...
function setup() {
  ...
  letters = [
    ...
    new Letter(letter['line'], 180, 30, 10, 20),
    ...
    new Letter(letter['line'], 110, 60, 10, 20),
    ...
    new Letter(letter['line'], 80, 85, 10, 20),
    ...
    new Letter(letter['line'], 70, 110, 10, 20),
    ...
    new Letter(letter['line'], 90, 135, 10, 20),
